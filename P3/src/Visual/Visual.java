        ...
        while (continuar) {
            ...
            switch (opcion) {
                ...
                case 11:
                    ...
                    piezas.add(new Pintura( "ID-Pintura001",            
                            "Pintura",                  
                            "La Noche Estrellada",     
                            1889,                       
                            "Vincent van Gogh",         
                    ...
                    piezas.add(new Escultura("ESC001",                   
                            "Escultura",                
                            "David",                    
                            1504,                       
                            ...
                            5575,                       
                            false,                     
                            "Ubicada en la Galería de la Academia de Florencia", 
                            "En exhibición",            
                            "Mármol"   
                    		));
                    piezas.add(new Fotografia("FOTO001",                
                            "Fotografia",             
                ...
                case 15:
                    ...
                    piezasParaComprar.add(new Pintura( "ID-Pintura001",            
                            "Pintura",                  
                            "La Noche Estrellada",      
                            1889,                       
                            "Vincent van Gogh",         
                    ...
                    piezasParaComprar.add(new Video("VID123",               
                            "Video",                
                            "Documental de la Naturaleza", 
                            2020,                  
                            "Jane Doe",          
                    ...
                    piezasParaComprar.add(new Escultura("ESC001",                   
                            "Escultura",               
                            "David",                   
                            1504,                       
                            "Michelangelo Buonarroti", 
                    ...
                    piezasParaComprar.add(new Fotografia("FOTO001",                
                            "Fotografia",             
                            "Atardecer en la ciudad",
                            2022,                     
                            "Alex Martinez",          
